...
<body>
    ...
    <header>
        <a href="./index.php">
            <div class="entete" id="entete">
                ...
                <h1>PIXELPORTAL</h1>
                <img src="../images/portal2.png" id="portal2" class="img-fluid" alt="portal blue">
            </div>
        </a>
    ...
    <main>
        <div class="boutonAccueil" id="boutonAccueil">
            <div class="row">
                <div class="col"></div>
                <div class="col"><a href="./views/register.php"><input type="submit" id="boutonRegister" class="boutonRegister" value="S'ENREGISTRER"></a></div>
                <div class="col"></div>
                <div class="col"></div>
                <div class="col"></div>
            </div>
            <div class="row">
                <div class="col"></div>
                <div class="col"><a href="./views/login.php"><input type="submit" id="boutonLogin" class="boutonLogin" value="   CONNEXION   "></a></div>
                <div class="col"></div>
                <div class="col"></div>
                <div class="col"></div>
            </div>
